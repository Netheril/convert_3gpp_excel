...
public class SheetParserUtilsTest {
    ...
    public void getColumnsWithTopBorder_succeed() {
        ...
        assertEquals(ImmutableSet.of(1, 2, 3), SheetParserUtils.getColumnsWithTopBorder(testSheet, 1, allColumns));
        assertEquals(ImmutableSet.of(1, 2, 3), SheetParserUtils.getColumnsWithTopBorder(testSheet, 4, allColumns));

        // Row 2 has top border at column 3, but not at other columns.
        assertEquals(ImmutableSet.of(3), SheetParserUtils.getColumnsWithTopBorder(testSheet, 2, allColumns));

        // Row 3 has top border at column 1, but not at other columns.
        assertEquals(ImmutableSet.of(1), SheetParserUtils.getColumnsWithTopBorder(testSheet, 3, allColumns));

        // Row 5 has no top border at any column.
        assertEquals(ImmutableSet.of(), SheetParserUtils.getColumnsWithTopBorder(testSheet, 5, allColumns));
    }
    ...
    public void getColumnsWithTopBorder_fail() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> SheetParserUtils.getColumnsWithTopBorder(testSheet, 0, ImmutableSet.of(Integer.MAX_VALUE)));
    }
    ...
    public void getRowsWithLeftBorder_expectedResult() {
        ...
        assertEquals(ImmutableSet.of(1, 2, 3), SheetParserUtils.getRowsWithLeftBorder(testSheet, allRows, 1));
        assertEquals(ImmutableSet.of(1, 2, 3), SheetParserUtils.getRowsWithLeftBorder(testSheet, allRows, 4));
    ...
    public void hasLeftBorder_exceptionalCases() {
        ...
        assertThrows(
                IllegalArgumentException.class,
                () -> SheetParserUtils.getRowsWithLeftBorder(testSheet, ImmutableSet.of(Integer.MAX_VALUE), 0));
    }
